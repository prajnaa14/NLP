...
// Laplace smoothing, often referred to as add-one smoothing, is a statistical technique 
// that prevents zero probability in statistical models by adding a small constant to each count in a frequency distribution.
 public class exp2 {
